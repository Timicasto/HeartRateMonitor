...
\begin{appendices}
	...
	\section{附录 1 - PCB原理图}
		...
		\begin{figure}[H]
			\centering
			\rotatebox{90}{\includegraphics[width=2\textwidth]{schem.pdf}}
			\hspace{-10mm}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=1.9\textwidth]{HeartRateMonitor-B_Cu.pdf}}
		\caption{背面铜层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-B_Mask.pdf}}
		\caption{背面阻焊层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-B_Paste.pdf}}
		\caption{背面SMT锡膏层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-B_Silkscreen.pdf}}
		\caption{背面丝印层}
	\end{figure}
		...
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-Edge_Cuts.pdf}}
		\caption{板框层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-F_Cu.pdf}}
		\caption{正面铜层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-F_Mask.pdf}}
		\caption{正面阻焊层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-F_Paste.pdf}}
		\caption{正面SMT锡膏层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=2\textwidth]{HeartRateMonitor-F_Silkscreen.pdf}}
		\caption{正面丝印层}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\setlength{\leftskip}{-42.5pt}
		\rotatebox{90}{\includegraphics[width=1.9\textwidth]{HeartRateMonitor-User_1.pdf}}
		\caption{参数层}
	\end{figure}
